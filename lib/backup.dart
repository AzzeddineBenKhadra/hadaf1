...
class ResultsScreen extends StatelessWidget {
  ...
  Future<void> _sendTestNotification() async {
    await flutterLocalNotificationsPlugin.show(
      0,
      'اختبار الإشعار',
      'هذا إشعار تجريبي للتحقق من عمل الإشعارات.',
  ...
  void _startHealthTips(BuildContext context) {
  ...
  @override
  Widget build(BuildContext context) {
    double proteinIntake = weight * 2.0;
    double carbIntake = weight * 3.5;
    double fatIntake = weight * 1.0;
    
    List<String> trainingPlans = _getTrainingPlans(goal, workoutFrequency);
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 10),
                      Column(
                        children: trainingPlans.map((plan) => Padding(
  ...
  List<String> _getTrainingPlans(String goal, String frequency) {
    if (goal == "زيادة الكتلة العضلية") {
      return [
        "تمارين رفع الأثقال 4-5 أيام أسبوعياً مع تمارين مركبة ورفع أوزان ثقيلة تدريجياً.",
        "تمارين عضلات الجسم العلوي والسفلي بالتناوب.",
        "تمارين القوة باستخدام الأوزان الحرة والأجهزة الرياضية."
      ];
    } else if (goal == "خسارة الوزن") {
      return [
        "تمارين كارديو عالية الشدة 3-5 أيام أسبوعياً مع تمارين مقاومة معتدلة لتحسين الحرق.",
        "تمارين HIIT لزيادة معدل الأيض وحرق الدهون بسرعة.",
        "تمارين التحمل مثل الجري وركوب الدراجة والمشي السريع."
      ];
    } else {
      return [
        "تمارين مختلطة: كارديو 3 أيام أسبوعياً وتمارين مقاومة متوسطة الشدة لتحسين القوة واللياقة.",
        "تمارين المرونة والتوازن مثل اليوغا والبيلاتس لتحسين الحركة والمرونة.",
        "تمارين دائرية تجمع بين تمارين الكارديو والقوة لزيادة الكفاءة البدنية."
      ];
    }
  }
}
